    ...
    <MDBNavbar expand='lg' light bgColor='light' className='my-4 ' >
      <MDBContainer fluid >
        <MDBNavbarBrand className='mb-lg-1 me-4' >
          <h3 style={{fontFamily:"revert-layer"}}>W<sub>OOD</sub> G<sub>ALLARY</sub></h3></MDBNavbarBrand>
        ...
        <MDBCollapse navbar show={showBasic}>
          <MDBNavbarNav className='mr-auto  mb-lg-1 '>
            <MDBNavbarItem>
              <MDBNavbarLink active aria-current='page'  style={{fontFamily:"cursive"}} onClick={()=>navigate('/')} href='#home'>Home</MDBNavbarLink>
            </MDBNavbarItem>
            <MDBNavbarItem>
              <MDBNavbarLink onClick={()=>navigate('/allproducts')}>Products</MDBNavbarLink>
            </MDBNavbarItem>

            <MDBNavbarItem>
              <MDBDropdown>
                <MDBDropdownToggle tag='a' className='nav-link'   style={{fontFamily:"cursive"}}role='button'>Categories</MDBDropdownToggle>
                <MDBDropdownMenu className='text-center'>
                  <MDBDropdownItem onClick={()=>navigate('/table')} >Tables</MDBDropdownItem>
                  <MDBDropdownItem onClick={()=>navigate('/bed')}>Beds</MDBDropdownItem>
                  <MDBDropdownItem onClick={()=>navigate('/sofa')}>Sofas</MDBDropdownItem>
                  <MDBDropdownItem onClick={()=>navigate('/chair')}> Chairs</MDBDropdownItem>
                  <MDBDropdownItem onClick={()=>navigate('/wardrobe')}>Wardrobes</MDBDropdownItem>
                </MDBDropdownMenu>
              </MDBDropdown>
            </MDBNavbarItem>
          </MDBNavbarNav>
        ...
        <MDBBtn outline  rippleColor='success' color='success' onClick={()=>navigate("/login")} className='me-2' type='button'>
          Login
        </MDBBtn>
